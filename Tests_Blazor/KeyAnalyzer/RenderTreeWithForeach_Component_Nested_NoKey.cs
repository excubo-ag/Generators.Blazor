...
namespace Tests_Blazor
{
    ...
    {
        [Fact]
        public void RenderTreeWithForeach_Component_Nested_NoKey()
        {
            var userSource = @"
namespace Foo
{
...
";
            ...
            generatorDiagnostics.Verify(new DiagnosticResult("BB0003", "foreach", Microsoft.CodeAnalysis.DiagnosticSeverity.Warning).WithLocation(11, 13));
        }
    }
}